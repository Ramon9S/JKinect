...
-- CREACION DEL USUARIO jkinect
CREATE USER 'jkinect'@'localhost' identified by '1234';

grant all on *.* to 'jkinect'@'localhost';

-- Creacion de la base de datos terapiaKinectInterfaceDB
DROP DATABASE IF EXISTS jkinectdb;
CREATE DATABASE IF NOT EXISTS jkinectdb;
USE jkinectdb;
...
-- INSERT INTO NombreTabla [(Campo1, …, CampoN)] VALUES (Valor1, …, ValorN)
INSERT INTO paciente (nombre, apellidos, email, foto, fecha_nacimiento, sexo, rfid, usuario, password) VALUES ( "SANDRA", "GOMEZ PEREZ","I34GOPES@UCO.ES", "images/Logos/FotosPac/M1.jpg", '1990-04-22', "M", "SJEU37DJ","SAGO33","PRUEBA2");

INSERT INTO paciente (nombre, apellidos, email, foto, fecha_nacimiento, sexo, rfid, usuario, password) VALUES ( "CARLOS", "SANCHEZ ROSAS","I22SAROC@UCO.ES", "images/Logos/FotosPac/h1.jpg", '1995-10-05', "H", "SJEU37DJ","CASA33","PRUEBA2");

INSERT INTO paciente (nombre, apellidos, email, foto, fecha_nacimiento, sexo, rfid, usuario, password) VALUES ( "FRANCISCO", "PINO OLMO","I34PIOLF@UCO.ES", "images/Logos/FotosPac/h2.jpg", '1995-11-07', "H", "SJEU37DJ","FRPI33","PRUEBA2");

INSERT INTO paciente (nombre, apellidos, email, foto, fecha_nacimiento, sexo, rfid, usuario, password) VALUES ( "LUISA", "MARTINEZ LLANOS","I31MALLL@UCO.ES", "images/Logos/FotosPac/M2.jpg", '1994-01-08', "M", "SJEU37DJ","LUMA33","PRUEBA2");

INSERT INTO paciente (nombre, apellidos, email, foto, fecha_nacimiento, sexo, rfid, usuario, password) VALUES ( "PABLO", "PRADO RIOS","I09PRRIP@UCO.ES", "images/Logos/FotosPac/h3.jpg", '1992-04-03', "H", "SJEU37DJ","PAPR33","PRUEBA2");

INSERT INTO paciente (nombre, apellidos, email, foto, fecha_nacimiento, sexo, rfid, usuario, password) VALUES ( "HOUDINI", "MARIO ELUIGI","I07MAELH@UCO.ES", "images/Logos/FotosPac/h4.jpg", '1998-05-12', "H", "SJEU37DJ","HOMA33","PRUEBA2");

INSERT INTO paciente (nombre, apellidos, email, foto, fecha_nacimiento, sexo, rfid, usuario, password) VALUES ( "RAFAEL", "CASTRO VAZQUEZ","I25CAVAR@UCO.ES", "images/Logos/FotosPac/h5.jpg", '1992-03-15', "H", "SJEU37DJ","RACA33","PRUEBA2");

INSERT INTO paciente (nombre, apellidos, email, foto, fecha_nacimiento, sexo, rfid, usuario, password) VALUES ( "NICOLAS", "REBECAS DEPUNTO","I22REDEN@UCO.ES", "images/Logos/FotosPac/h6.jpg", '1990-08-18', "H", "SJEU37DJ","NIRE33","PRUEBA2");

INSERT INTO paciente (nombre, apellidos, email, foto, fecha_nacimiento, sexo, rfid, usuario, password) VALUES ( "TERESA", "CARTON POVEDANO","I03CAPOT@UCO.ES", "images/Logos/FotosPac/M3.jpg", '1991-09-02', "M", "SJEU37DJ","TECA33","PRUEBA2");

INSERT INTO paciente (nombre, apellidos, email, foto, fecha_nacimiento, sexo, rfid, usuario, password) VALUES ( "EVA", "GALERA OLMEDO","I05GAOLE@UCO.ES", "images/Logos/FotosPac/M4.jpg", '1997-10-09', "M", "SJEU37DJ","EVGA33","PRUEBA2");

INSERT INTO paciente (nombre, apellidos, email, foto, fecha_nacimiento, sexo, rfid, usuario, password) VALUES ( "JAVIER", "JEMEZ LUJAN","I26JELUJ@UCO.ES", "images/Logos/FotosPac/h7.jpg", '1999-12-11', "H", "SJEU37DJ","JAJE33","PRUEBA2");

INSERT INTO paciente (nombre, apellidos, email, foto, fecha_nacimiento, sexo, rfid, usuario, password) VALUES ( "LAURA", "MUÑOZ BENAVENTE","I30MUBEL@UCO.ES", "images/Logos/FotosPac/M5.jpg", '1992-06-14', "M", "SJEU37DJ","LAMU33","PRUEBA2");
